...
suite('Jupyter Execution', async () => {
    ...
    test('Working notebook and commands found', async () => {
        ...
        await assert.isFulfilled(
            jupyterExecutionFactory.connectToNotebookServer({ allowUI: () => false, purpose: '', resource: undefined }),
    ...
    test('Failing notebook throws exception', async () => {
        ...
        await assert.isRejected(
            execution.connectToNotebookServer({ allowUI: () => false, purpose: '', resource: undefined }),
